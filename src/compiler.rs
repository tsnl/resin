...
mod tests {
    ...
    fn unchanged_snapshots_are_shared_and_only_dependents_are_invalidated() {
        ...
        compiler
            .set_overlay(&entry, "import { \"lib.resin\" }; value;".into())
            .unwrap();
        compiler
            .set_overlay(&library, "export { value }; value = 1;".into())
            .unwrap();
        compiler
            .set_overlay(&independent, "other = 2;".into())
            .unwrap();
        ...
        compiler
            .set_overlay(&library, "export { renamed }; renamed = 1;".into())
            .unwrap();
