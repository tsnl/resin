//! Sorting as a composition: LSD radix sort built from bit ops, [`super::scan`],
...
use super::scan::cumsum;
use super::{IndexKeyElement, ScatterOp, Tensor};
...
mod tests {
    ...
    #[test]
    fn argsort_shapes() {
        let keys = Tensor::parameter_typed(&[10], ElementType::U32);
