...
| [Cut holes in a rasterized surface](alpha-masking.md) | An alpha-masked checkerboard over a gradient | Optional fragment outputs, discard, and sampling an alpha buffer |
...
support and runs without a window. The alpha-mask example also runs without a
