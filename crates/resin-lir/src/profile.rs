...
fn instruction(typer: &TyperContext, op: &Instr) -> Result<(), String> {
    match op {
        ...
        Instr::GpuViewAllocate | Instr::GpuViewRange { .. } | Instr::GpuViewOffset | Instr::GpuViewRestrict | Instr::GpuViewAddress { .. } | Instr::GpuViewLoad { .. } | Instr::GpuViewStore | Instr::GpuViewReplace | Instr::GpuViewCopyTo | Instr::GpuViewCopyFrom | Instr::GpuViewCopyImage
