...
impl<B: Clone> MinibatchLoader<B> {
    pub fn new(
        ...
        Self {
            slots,
            batches: super::BatchIndices::new(dataset_len, batch_size, seed, drop_last),
            n: dataset_len,
            batch_size,
            drop_last,
        }
    ...
    pub fn rewind(&mut self, seed: u64) {
        self.batches = super::BatchIndices::new(self.n, self.batch_size, seed, self.drop_last);
    }
