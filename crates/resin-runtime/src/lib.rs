...
pub unsafe extern "C" fn resin_gpu_set_pipeline(
    ...
    match command_buffer.set_pipeline(pipeline) {
        Ok(()) => ResinStatus::Success,
        Err(status) => status,
    }
}
...
pub unsafe extern "C" fn resin_gpu_dispatch(
    ...
    match command_buffer.dispatch(root_data, group_count_x, group_count_y, group_count_z) {
        Ok(()) => ResinStatus::Success,
        Err(status) => status,
    }
}
...
pub unsafe extern "C" fn resin_gpu_begin_rendering(
    ...
    match command_buffer.begin_rendering(color, [clear_r, clear_g, clear_b, clear_a]) {
        Ok(()) => ResinStatus::Success,
        Err(status) => status,
    }
}
...
pub unsafe extern "C" fn resin_gpu_end_rendering(
    ...
    match command_buffer.end_rendering() {
        Ok(()) => ResinStatus::Success,
        Err(status) => status,
    }
}
...
pub unsafe extern "C" fn resin_gpu_draw(
    ...
    match command_buffer.draw(root_data, vertex_count) {
        Ok(()) => ResinStatus::Success,
        Err(status) => status,
    }
}
...
pub unsafe extern "C" fn resin_gpu_copy_image_to_buffer(
    ...
    match command_buffer.copy_image_to_buffer(image, dst) {
        Ok(()) => ResinStatus::Success,
        Err(status) => status,
    }
}
...
pub unsafe extern "C" fn resin_gpu_submit(
    ...
    match gpu.submit(*command_buffer) {
        Ok(()) => ResinStatus::Success,
        Err(status) => status,
    }
}
